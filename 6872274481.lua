...
function checklagback()
    ...
    game:GetService("StarterGui"):SetCore("ChatMakeSystemMessage",{
        Text = "Zylaware | privete, Loaded!",
        Color = Color3.fromRGB(255,65,65),
        Font = Enum.Font.Code,
    })
wait(1)
    game:GetService("StarterGui"):SetCore("ChatMakeSystemMessage",{
        Text = "Just Win u Have Zylaware So Is Not Hard!",
        Color = Color3.fromRGB(255,65,65),
        Font = Enum.Font.Code,
    })
wait(1)
...
createwarning("ZylawarePrivate", "BlueTexturePack Made By zyla#7657!   ", 5)
...
createwarning("ZylawarePrivate", "BlackTexturePack Made By zyla#7657!   ", 5)
...
createwarning("ZylawarePrivate", "RedTexturePack Made By zyla#7657!   ", 5)
...
s.Parent = Lighting
		...
		createwarning("Zylaware Config", "Join A New Match To Reset Skybox And Ambience.", 3)
		end
	end
})
		...
		SizeChanger = GuiLibrary["ObjectsThatCanBeSaved"]["RenderWindow"]["Api"].CreateOptionsButton({
			...
			["Function"] = function(callback)
				if callback then
					...
					createwarning("Hacer Config", "Disabled Next Time You Die", 3)
				end
			end
		})
	end)
