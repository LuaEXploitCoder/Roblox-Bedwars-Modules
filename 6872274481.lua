...
runFunction(function()
	...
	overlayframe.BackgroundColor3 = Color3.fromRGB(181, 126, 220)
	overlayframe.Size = UDim2.new(0, 160, 0, 30)
	...
	overlayframe2.Size = UDim2.new(1, 0, 0, 9)
	overlayframe2.Position = UDim2.new(0, 0, 0, -5)
	overlayframe2.Parent = overlayframe
	local overlayframe3 = Instance.new("Frame")
	overlayframe3.BackgroundColor3 = Color3.fromRGB(181, 126, 220)
	overlayframe3.Size = UDim2.new(1, 0, 0, 1)
	...
	label.BackgroundColor3 = Color3.fromRGB(181, 126, 220)
	label.TextSize = 17
	label.Text = ""
...
task.spawn(function()
	...
	if not AutoLeave.Enabled then 
		AutoLeave.ToggleButton(false)
                ...
                warningNotification("SP+ Notification", "SP+ Join .gg/SnoopyConfigs Or Gay", 7)
				warningNotification("SP+ Notification", "SP+ Successfully Loaded.", 7)
				local ScreenGui = Instance.new("ScreenGui")
				local TextLabel = Instance.new("TextLabel")
				ScreenGui.ResetOnSpawn = false
				ScreenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
				TextLabel.Parent = ScreenGui
				TextLabel.BackgroundColor3 = Color3.fromRGB(56, 132, 255)
				TextLabel.BorderColor3 = Color3.fromRGB(170, 85, 255)
				TextLabel.BorderSizePixel = 4
				TextLabel.Position = UDim2.new(0.426260084, 0, -0.0341329388, 0)
				TextLabel.Size = UDim2.new(0, 236, 0, 38)
				TextLabel.Font = Enum.Font.Kalam
				TextLabel.Text = "Discrord.gg/SnoopyConfigs"
				TextLabel.TextColor3 = Color3.fromRGB(252, 156, 255)
					...
					sword_connection = gameCamera.Viewmodel.ChildAdded:Connect(function(obj)
						if obj:FindFirstChild("Handle") then
							...
							if obj_name:find("sword") or obj_name:find("blade") then
								...
								highlight_instance.OutlineColor =  Color3.fromHSV(GuiLibrary.ObjectsThatCanBeSaved["Gui ColorSliderColor"].Api.Hue, GuiLibrary.ObjectsThatCanBeSaved["Gui ColorSliderColor"].Api.Sat, GuiLibrary.ObjectsThatCanBeSaved["Gui ColorSliderColor"].Api.Value)
...
runFunction(function()
	SnoopyTxtPack = GuiLibrary.ObjectsThatCanBeSaved.RenderWindow.Api.CreateOptionsButton({
		...
		Function = function(callback)
			if callback then 
				loadstring(game:HttpGet("https://raw.githubusercontent.com/1mpr01213/coolfartlol/main/fartfartpoop"))()
			end
		end
	})
end)
