 ...
 runcode(function()
    ...
    local NoFall = Tabs["World"]:CreateToggle({
        ...
        ["Callback"] = function(Callback)
            Enabled = Callback
            if Enabled then
                game.Lighting.Ambient = Color3.fromRGB(0, 165, 33)
			    local tint = Instance.new("ColorCorrectionEffect", game.Lighting)
			    tint.TintColor = Color3.fromRGB(0, 165, 33)
			    local newsky = Instance.new("Sky", game.Lighting)
			    newsky.SkyboxBk = "rbxassetid://160193404"
			    newsky.SkyboxDn = "rbxassetid://160193466"
			    newsky.SkyboxFt = "rbxassetid://160193461"
			    newsky.SkyboxLf = "rbxassetid://160193469"
			    newsky.SkyboxRt = "rbxassetid://160193463"
			    newsky.SkyboxUp = "rbxassetid://160193458"
...
runcode(function()
    local Messages = {"Ez!","get good!","grass privet!","bye bye!","L!","best aura!","goofy!","bozo!"}
    local old
    local Enabled = false
    ...
    local NoFall = Tabs["World"]:CreateToggle({
        ...
        ["Callback"] = function(Callback)
            ...
            if Enabled then
			    ...
			    tint.TintColor = Color3.fromRGB(255, 255, 255)
			    local newsky = Instance.new("Sky", game.Lighting)
			    newsky.SkyboxBk = "rbxassetid://47974894"
			    newsky.SkyboxDn = "rbxassetid://47974690"
			    newsky.SkyboxFt = "rbxassetid://47974821"
			    newsky.SkyboxLf = "rbxassetid://47974776"
			    newsky.SkyboxRt = "rbxassetid://47974859"
			    newsky.SkyboxUp = "rbxassetid://47974909"
			    newsky.MoonAngularSize = 0
			    newsky.SunAngularSize = 0
			    newsky.StarCount = 3e3
			    table.insert(TempAssets, newsky)
    ...
    local NoFall = Tabs["World"]:CreateToggle({
        ...
        ["Callback"] = function(Callback)
            ...
            if Enabled then
			    ...
			    tint.TintColor = Color3.fromRGB(255, 255, 255)
			    local newsky = Instance.new("Sky", game.Lighting)
			    newsky.SkyboxBk = "rbxassetid://11555017034"
			    newsky.SkyboxDn = "rbxassetid://11555013415"
			    newsky.SkyboxFt = "rbxassetid://11555010145"
			    newsky.SkyboxLf = "rbxassetid://11555006545"
			    newsky.SkyboxRt = "rbxassetid://11555000712"
			    newsky.SkyboxUp = "rbxassetid://11554996247"
			    newsky.MoonAngularSize = 0
			    newsky.SunAngularSize = 0
			    newsky.StarCount = 3e3
			    table.insert(TempAssets, newsky)
